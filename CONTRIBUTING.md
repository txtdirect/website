...
Thank you for your interest in contributing to TXTdirect Website.  
This guide helps make contributing to TXTdirect Website simple and efficient for everyone.

### First contribution

If you are starting out contributing to TXTdirect Website, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/txtdirect/website/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the TXTdirect Website wants to achieve, please open up an issue first.
